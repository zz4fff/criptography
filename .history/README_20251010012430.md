...
After running the script, you can deactivate the virtual environment by running the following command:
...
To use the scripts, you need a virtual environment with Python 3.6 or higher installed.
